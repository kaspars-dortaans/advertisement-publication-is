    ...
    public partial class Initalmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeValueLists", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "text", nullable: false),
                    ContainsAdvertisements = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permisssions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueValidationRegex = table.Column<string>(type: "text", nullable: true),
                    AttributeValueListId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Attributes_AttributeValueLists_AttributeValueListId",
                        column: x => x.AttributeValueListId,
                        principalTable: "AttributeValueLists",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "AttributeValueListEntries",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    AttributeValueListId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeValueListEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttributeValueListEntries_AttributeValueLists_AttributeValu~",
                        column: x => x.AttributeValueListId,
                        principalTable: "AttributeValueLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdvertisementText = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdevertisementAttributeValues", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attributes_AttributeValueListId",
                table: "Attributes",
                column: "AttributeValueListId");

            migrationBuilder.CreateIndex(
                name: "IX_AttributeValueListEntries_AttributeValueListId",
